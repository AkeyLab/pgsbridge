# figures/figure_S2.R
#
# S2 Fig. Transferability for three population pairs in both directions, given
...
#
# Usage:  Rscript figures/figure_S2.R
...
ggsave(file.path(PRS_OUTPUT, "S2_Fig.pdf"), figure, height = 13, width = 13)
ggsave(file.path(PRS_OUTPUT, "S2_Fig.png"), figure, height = 13, width = 13,
       dpi = 300)
