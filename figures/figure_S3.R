# figures/figure_S3.R
#
# S3 Fig. Transferability for three population pairs in both directions, with
...
#
# Usage:  Rscript figures/figure_S3.R
...
ggsave(file.path(PRS_OUTPUT, "S3_Fig.pdf"), figure, height = 9, width = 13)
ggsave(file.path(PRS_OUTPUT, "S3_Fig.png"), figure, height = 9, width = 13,
       dpi = 300)
